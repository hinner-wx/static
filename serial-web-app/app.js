(() => {
      ...
      !function(e, t) {
        ...
        return (() => {
          ...
          var e = {4567: function(e2, t2, r) {
            ...
            var o = r(2950), s = r(1680), a = r(3614), c = r(2584), l = r(5435), h = r(3525), u = r(3551), f = r(9312), _ = r(6114), d = r(3656), p = r(9042), v = r(357), g = r(6954), y = r(4567), b = r(1296), S = r(7399), m = r(8460), C = r(8437), w = r(5680), E = r(3230), L = r(4725), k = r(428), A = r(8934), R = r(6465), x = r(5114), T = r(8969), O = r(4774), D = r(4269), P = typeof window != "undefined" ? window.document : null, M = function(e3) {
              function t3(t4) {
                t4 === void 0 && (t4 = {});
                var r2 = e3.call(this, t4) || this;
                return r2.browser = _, r2._keyDownHandled = false, r2._onCursorMove = new m.EventEmitter(), r2._onKey = new m.EventEmitter(), r2._onRender = new m.EventEmitter(), r2._onSelectionChange = new m.EventEmitter(), r2._onTitleChange = new m.EventEmitter(), r2._onBell = new m.EventEmitter(), r2._onFocus = new m.EventEmitter(), r2._onBlur = new m.EventEmitter(), r2._onA11yCharEmitter = new m.EventEmitter(), r2._onA11yTabEmitter = new m.EventEmitter(), r2._setup(), r2.linkifier = r2._instantiationService.createInstance(u.Linkifier), r2.linkifier2 = r2.register(r2._instantiationService.createInstance(R.Linkifier2)), r2.register(r2._inputHandler.onRequestBell(function() {
                  return r2.bell();
              ...
              return n(t3, e3), Object.defineProperty(t3.prototype, "options", {get: function() {
                ...
                if (this._colorManager) {
                  for (var i2 = 0, n2 = e4.colors; i2 < n2.length; i2++) {
                    var o2 = n2[i2], s2 = O.rgba.toColor(o2.red, o2.green, o2.blue);
                    this._colorManager.colors.ansi[o2.colorIndex] = s2;
                  }
                ...
                this._renderService = this.register(this._instantiationService.createInstance(E.RenderService, n2, this.rows, this.screenElement)), this._instantiationService.setService(L.IRenderService, this._renderService), this.register(this._renderService.onRenderedBufferChange(function(e5) {
                  ...
                  return t4.viewport.syncScrollArea();
                })), this._selectionService = this.register(this._instantiationService.createInstance(f.SelectionService, this.element, this.screenElement, this.linkifier2)), this._instantiationService.setService(L.ISelectionService, this._selectionService), this.register(this._selectionService.onRequestScrollLines(function(e5) {
            ...
            var i = r(511), n = r(3236), o = r(9042), s = r(8460), a = r(244), c = function() {
              ...
              }, enumerable: false, configurable: true}), Object.defineProperty(e3.prototype, "onBell", {get: function() {
            ...
            var i = r(643), n = r(8803), o = r(1420), s = r(3734), a = r(1752), c = r(4774), l = r(9631), h = function() {
              ...
              return e3.prototype.dispose = function() {
                ...
                this._ctx.font = this._getFont(false, false), this._ctx.textBaseline = "ideographic", this._clipRow(r2), this._ctx.fillText(e4.getChars(), t3 * this._scaledCellWidth + this._scaledCharLeft, r2 * this._scaledCellHeight + this._scaledCharTop + this._scaledCharHeight);
                ...
                if (this._ctx.save(), this._ctx.font = this._getFont(!!e4.isBold(), !!e4.isItalic()), this._ctx.textBaseline = "ideographic", e4.isInverse())
                  if (i2)
                ...
                this._clipRow(r2), e4.isDim() && (this._ctx.globalAlpha = n.DIM_OPACITY), this._ctx.fillText(e4.getChars(), t3 * this._scaledCellWidth + this._scaledCharLeft, r2 * this._scaledCellHeight + this._scaledCharTop + this._scaledCharHeight), this._ctx.restore();
            ...
            var _ = function() {
              ...
              return Object.defineProperty(e3.prototype, "isPaused", {get: function() {
                ...
                var t3 = this;
                e4 === void 0 && (e4 = u), this._blinkInterval && window.clearInterval(this._blinkInterval), this._blinkStartTimeout = window.setTimeout(function() {
            ...
            var a = r(1546), c = r(8803), l = r(2040), h = r(2585), u = function(e3) {
              ...
              return n(t3, e3), t3.prototype.resize = function(t4) {
                ...
                if (e4.fg === c.INVERTED_DEFAULT_COLOR ? this._ctx.fillStyle = this._colors.background.css : e4.fg && l.is256Color(e4.fg) ? this._ctx.fillStyle = this._colors.ansi[e4.fg].css : this._ctx.fillStyle = this._colors.foreground.css, e4.y1 === e4.y2)
            ...
            var a = r(9596), c = r(4149), l = r(2512), h = r(5098), u = r(844), f = r(4725), _ = r(2585), d = r(1420), p = r(8460), v = 1, g = function(e3) {
              function t3(t4, r2, i2, n2, o2, s2, u2, f2) {
                ...
                var d2 = _2._optionsService.options.allowTransparency;
              ...
              return n(t3, e3), Object.defineProperty(t3.prototype, "onRequestRedraw", {get: function() {
                ...
                for (var t4 = 0, r2 = this._renderLayers; t4 < r2.length; t4++)
                  r2[t4].dispose();
                e3.prototype.dispose.call(this), d.removeTerminalFromCache(this._id);
            ...
            var d = function(e3) {
              ...
              return n(t3, e3), t3.prototype.dispose = function() {
                ...
                this._tmpCtx.font = n2 + " " + i2 + " " + this._config.fontSize * this._config.devicePixelRatio + "px " + this._config.fontFamily, this._tmpCtx.textBaseline = "ideographic", this._tmpCtx.fillStyle = this._getForegroundColor(e4).css, e4.dim && (this._tmpCtx.globalAlpha = o.DIM_OPACITY), this._tmpCtx.fillText(e4.chars, 0, this._config.scaledCharHeight), this._tmpCtx.restore();
            ...
            var a = r(3787), c = r(8803), l = r(844), h = r(4725), u = r(2585), f = r(8460), _ = r(4774), d = r(9631), p = "xterm-dom-renderer-owner-", v = "xterm-fg-", g = "xterm-bg-", y = "xterm-focus", b = 1, S = function(e3) {
              function t3(t4, r2, i2, n2, o2, s2, c2, l2, h2, u2) {
                ...
                return f2._colors = t4, f2._element = r2, f2._screenElement = i2, f2._viewportElement = n2, f2._linkifier = o2, f2._linkifier2 = s2, f2._charSizeService = l2, f2._optionsService = h2, f2._bufferService = u2, f2._terminalClass = b++, f2._rowElements = [], f2._rowContainer = document.createElement("div"), f2._rowContainer.classList.add("xterm-rows"), f2._rowContainer.style.lineHeight = "normal", f2._rowContainer.setAttribute("aria-hidden", "true"), f2._refreshRowElements(f2._bufferService.cols, f2._bufferService.rows), f2._selectionContainer = document.createElement("div"), f2._selectionContainer.classList.add("xterm-selection"), f2._selectionContainer.setAttribute("aria-hidden", "true"), f2.dimensions = {scaledCharWidth: 0, scaledCharHeight: 0, scaledCellWidth: 0, scaledCellHeight: 0, scaledCharLeft: 0, scaledCharTop: 0, scaledCanvasWidth: 0, scaledCanvasHeight: 0, canvasWidth: 0, canvasHeight: 0, actualCellWidth: 0, actualCellHeight: 0}, f2._updateDimensions(), f2._injectCss(), f2._rowFactory = c2.createInstance(a.DomRendererRowFactory, document, f2._colors), f2._element.classList.add(p + f2._terminalClass), f2._screenElement.appendChild(f2._rowContainer), f2._screenElement.appendChild(f2._selectionContainer), f2._linkifier.onShowLinkUnderline(function(e4) {
            ...
            var f = function() {
              function e3(e4, t3, r2, i2) {
                this._document = e4, this._colors = t3, this._characterJoinerService = r2, this._optionsService = i2, this._workCell = new a.CellData();
              }
              return e3.prototype.setColors = function(e4) {
                ...
                for (g = 0; g < v; g++) {
                  ...
                  if (y !== 0) {
                    var b = false, S = g, m = this._workCell;
                    if (p.length > 0 && g === p[0][0]) {
                      b = true;
                      var C = p.shift();
                      m = new u.JoinedCellData(this._workCell, e4.translateToString(true, C[0], C[1]), C[1] - C[0]), S = C[1] - 1, y = m.getWidth();
                    }
                    var w = this._document.createElement("span");
                    if (y > 1 && (w.style.width = h2 * y + "px"), b && (w.style.display = "inline", a2 >= g && a2 <= S && (a2 = g)), i2 && g === a2)
                    ...
                    m.isBold() && w.classList.add(t2.BOLD_CLASS), m.isItalic() && w.classList.add(t2.ITALIC_CLASS), m.isDim() && w.classList.add(t2.DIM_CLASS), m.isUnderline() && w.classList.add(t2.UNDERLINE_CLASS), m.isInvisible() ? w.textContent = s.WHITESPACE_CELL_CHAR : w.textContent = m.getChars() || s.WHITESPACE_CELL_CHAR;
                    var E = m.getFgColor(), L = m.getFgColorMode(), k = m.getBgColor(), A = m.getBgColorMode(), R = !!m.isInverse();
                    if (R) {
                      var x = E;
                      E = k, k = x;
                      var T = L;
                ...
                return i2 === void 0 && (i2 = l.color.ensureContrastRatio(t3, r2, this._optionsService.options.minimumContrastRatio), this._colors.contrastCache.setColor(this._workCell.bg, this._workCell.fg, i2 != null ? i2 : null)), !!i2 && (this._addStyle(e4, "color:" + i2.css), true);
              }, e3.prototype._addStyle = function(e4, t3) {
                e4.setAttribute("style", "" + (e4.getAttribute("style") || "") + t3 + ";");
              }, i([n(2, h.ICharacterJoinerService), n(3, c.IOptionsService)], e3);
            }();
            function _(e3, t3, r2) {
              for (; e3.length < r2; )
                e3 = t3 + e3;
            ...
            var a = r(6114), c = r(456), l = r(511), h = r(8460), u = r(4725), f = r(2585), _ = r(9806), d = r(9504), p = r(844), v = r(4841), g = String.fromCharCode(160), y = new RegExp(g, "g"), b = function(e3) {
              ...
              return n(t3, e3), Object.defineProperty(t3.prototype, "onLinuxMouseSelection", {get: function() {
                ...
                if (n2)
                  return this._model.selectionStart = [n2.start.x - 1, n2.start.y - 1], this._model.selectionStartLength = v.getRangeLength(n2, this._bufferService.cols), this._model.selectionEnd = void 0, true;
                ...
                if (r2 === void 0 && (r2 = true), i2 === void 0 && (i2 = true), !(e4[0] >= this._bufferService.cols)) {
                  ...
                  if (o2) {
                    ...
                    c2++;
                    var b2 = a2 + l2 - h2 + f2, S = Math.min(this._bufferService.cols, c2 - a2 + h2 + u2 - f2 - _2);
                    if (t4 || s2.slice(a2, c2).trim() !== "") {
                      if (r2 && b2 === 0 && o2.getCodePoint(0) !== 32) {
                      ...
                      if (i2 && b2 + S === this._bufferService.cols && o2.getCodePoint(this._bufferService.cols - 1) !== 32) {
            ...
            var o = r(844), s = r(2585), a = r(4348), c = r(7866), l = r(744), h = r(7302), u = r(6975), f = r(8460), _ = r(1753), d = r(3730), p = r(1480), v = r(7994), g = r(9282), y = r(5435), b = r(5981), S = false, m = function(e3) {
              function t3(t4) {
                var r2 = e3.call(this) || this;
            ...
            var o, s = r(2584), a = r(7116), c = r(2015), l = r(844), h = r(8273), u = r(482), f = r(8437), _ = r(8460), d = r(643), p = r(511), v = r(3734), g = r(2585), y = r(6242), b = r(6351), S = {"(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2}, m = 131072;
            function C(e3, t3) {
              if (e3 > 24)
            ...
            var w = function() {
              ...
              function t3(t4, r2, i2, n2, o2, l2, h2, d2, v2) {
                ...
                g2._bufferService = t4, g2._charsetService = r2, g2._coreService = i2, g2._dirtyRowService = n2, g2._logService = o2, g2._optionsService = l2, g2._coreMouseService = h2, g2._unicodeService = d2, g2._parser = v2, g2._parseBuffer = new Uint32Array(4096), g2._stringDecoder = new u.StringToUtf32(), g2._utf8Decoder = new u.Utf8ToUtf32(), g2._workCell = new p.CellData(), g2._windowTitle = "", g2._iconName = "", g2._windowTitleStack = [], g2._iconNameStack = [], g2._curAttrData = f.DEFAULT_ATTR_DATA.clone(), g2._eraseAttrDataInternal = f.DEFAULT_ATTR_DATA.clone(), g2._onRequestBell = new _.EventEmitter(), g2._onRequestRefreshRows = new _.EventEmitter(), g2._onRequestReset = new _.EventEmitter(), g2._onRequestSyncScrollBar = new _.EventEmitter(), g2._onRequestWindowsOptionsReport = new _.EventEmitter(), g2._onA11yChar = new _.EventEmitter(), g2._onA11yTab = new _.EventEmitter(), g2._onCursorMove = new _.EventEmitter(), g2._onLineFeed = new _.EventEmitter(), g2._onScroll = new _.EventEmitter(), g2._onTitleChange = new _.EventEmitter(), g2._onAnsiColorChange = new _.EventEmitter(), g2._parseStack = {paused: false, cursorStartX: 0, cursorStartY: 0, decodedLength: 0, position: 0}, g2.register(g2._parser), g2._parser.setCsiHandlerFallback(function(e4, t5) {
                ...
                }), g2._parser.registerDcsHandler({intermediates: "$", final: "q"}, new w(g2._bufferService, g2._coreService, g2._logService, g2._optionsService)), g2;
              }
              return n(t3, e3), Object.defineProperty(t3.prototype, "onRequestBell", {get: function() {
                ...
                var r2, i2 = this._bufferService.buffer, n2 = i2.x, o2 = i2.y, s2 = 0, a2 = this._parseStack.paused;
                if (a2) {
                  if (r2 = this._parser.parse(this._parseBuffer, this._parseStack.decodedLength, t4))
                    return this._logSlowResolvingAsync(r2), r2;
                  n2 = this._parseStack.cursorStartX, o2 = this._parseStack.cursorStartY, this._parseStack.paused = false, e4.length > m && (s2 = this._parseStack.position + m);
                }
                if (this._logService.debug("parsing data", e4), this._parseBuffer.length < e4.length && this._parseBuffer.length < m && (this._parseBuffer = new Uint32Array(Math.min(e4.length, m))), a2 || this._dirtyRowService.clearRange(), e4.length > m)
                  for (var c2 = s2; c2 < e4.length; c2 += m) {
                    var l2 = c2 + m < e4.length ? c2 + m : e4.length, h2 = typeof e4 == "string" ? this._stringDecoder.decode(e4.substring(c2, l2), this._parseBuffer) : this._utf8Decoder.decode(e4.subarray(c2, l2), this._parseBuffer);
                    if (r2 = this._parser.parse(this._parseBuffer, h2))
                      return this._preserveStack(n2, o2, h2, c2), this._logSlowResolvingAsync(r2), r2;
                  }
                else if (!a2 && (h2 = typeof e4 == "string" ? this._stringDecoder.decode(e4, this._parseBuffer) : this._utf8Decoder.decode(e4, this._parseBuffer), r2 = this._parser.parse(this._parseBuffer, h2)))
                  return this._preserveStack(n2, o2, h2, 0), this._logSlowResolvingAsync(r2), r2;
                (i2 = this._bufferService.buffer).x === n2 && i2.y === o2 || this._onCursorMove.fire(), this._onRequestRefreshRows.fire(this._dirtyRowService.start, this._dirtyRowService.end);
                  ...
                  if (a2 && this._onA11yChar.fire(u.stringFromCodePoint(i2)), n2 || !o2.x) {
                    if (o2.x + n2 - 1 >= c2) {
                      if (l2) {
                        ...
                        o2.x = 0, o2.y++, o2.y === o2.scrollBottom + 1 ? (o2.y--, this._bufferService.scroll(this._eraseAttrData(), true)) : (o2.y >= this._bufferService.rows && (o2.y = this._bufferService.rows - 1), o2.lines.get(o2.ybase + o2.y).isWrapped = true), _2 = o2.lines.get(o2.ybase + o2.y);
                ...
                return e4.final !== "t" || e4.prefix || e4.intermediates ? this._parser.registerCsiHandler(e4, t4) : this._parser.registerCsiHandler(e4, function(e5) {
                  return !C(e5.params[0], r2._optionsService.options.windowOptions) || t4(e5);
                });
              }, t3.prototype.registerDcsHandler = function(e4, t4) {
                ...
                var e4 = this._bufferService.buffer;
                return this._dirtyRowService.markDirty(e4.y), this._optionsService.options.convertEol && (e4.x = 0), e4.y++, e4.y === e4.scrollBottom + 1 ? (e4.y--, this._bufferService.scroll(this._eraseAttrData())) : e4.y >= this._bufferService.rows && (e4.y = this._bufferService.rows - 1), e4.x >= this._bufferService.cols && e4.x--, this._dirtyRowService.markDirty(e4.y), this._onLineFeed.fire(), true;
                ...
                if (!C(e4.params[0], this._optionsService.options.windowOptions))
                  return true;
                ...
                for (var t4, r2 = {colors: []}, i2 = /(\d+);rgb:([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})/gi; (t4 = i2.exec(e4)) !== null; )
                ...
                this._restrictCursor();
                var e4 = this._bufferService.buffer;
                return this._bufferService.buffer.y++, e4.y === e4.scrollBottom + 1 ? (e4.y--, this._bufferService.scroll(this._eraseAttrData())) : e4.y >= this._bufferService.rows && (e4.y = this._bufferService.rows - 1), this._restrictCursor(), true;
              ...
              return e3.prototype.getNullCell = function(e4) {
                ...
                if (i2.length > 0) {
                  ...
                  for (v = 0; v < this.lines.length; v++)
                    k.push(this.lines.get(v));
                  var A = this.lines.length, R = A - 1, x = 0, T = i2[x];
                  this.lines.length = Math.min(this.lines.maxLength, this.lines.length + o2);
                  var O = 0;
                  for (v = Math.min(this.lines.maxLength - 1, A + o2 - 1); v >= 0; v--)
                    if (T && T.start > R + O) {
                      for (var D = T.newLines.length - 1; D >= 0; D--)
                        this.lines.set(v--, T.newLines[D]);
                      v++, L.push({index: R + 1, amount: T.newLines.length}), O += T.newLines.length, T = i2[++x];
                    } else
                      this.lines.set(v, k[R--]);
                  var P = 0;
                  for (v = L.length - 1; v >= 0; v--)
                    L[v].index += P, this.lines.onInsertEmitter.fire(L[v]), P += L[v].amount;
                  var M = Math.max(0, A + o2 - this.lines.maxLength);
            ...
            var u = function(e3) {
              function r2(r3) {
                var i2 = e3.call(this) || this;
                return i2._optionsService = r3, i2.isUserScrolling = false, i2._onResize = new l.EventEmitter(), i2._onScroll = new l.EventEmitter(), i2.cols = Math.max(r3.options.cols, t2.MINIMUM_COLS), i2.rows = Math.max(r3.options.rows, t2.MINIMUM_ROWS), i2.buffers = new c.BufferSet(r3, i2), i2;
              }
            ...
            Object.defineProperty(t2, "__esModule", {value: true}), t2.IUnicodeService = t2.LogLevelEnum = t2.IOptionsService = t2.ILogService = t2.IInstantiationService = t2.IDirtyRowService = t2.ICharsetService = t2.ICoreService = t2.ICoreMouseService = t2.IBufferService = void 0;
            var i, n = r(8343);
            t2.IBufferService = n.createDecorator("BufferService"), t2.ICoreMouseService = n.createDecorator("CoreMouseService"), t2.ICoreService = n.createDecorator("CoreService"), t2.ICharsetService = n.createDecorator("CharsetService"), t2.IDirtyRowService = n.createDecorator("DirtyRowService"), t2.IInstantiationService = n.createDecorator("InstantiationService"), t2.ILogService = n.createDecorator("LogService"), t2.IOptionsService = n.createDecorator("OptionsService"), (i = t2.LogLevelEnum || (t2.LogLevelEnum = {}))[i.DEBUG = 0] = "DEBUG", i[i.INFO = 1] = "INFO", i[i.WARN = 2] = "WARN", i[i.ERROR = 3] = "ERROR", i[i.OFF = 4] = "OFF", t2.IUnicodeService = n.createDecorator("UnicodeService");
          }, 1480: (e2, t2, r) => {
        ...
        for (; ; ) {
          ...
          if (value) {
            if (tail.length > 0) {
              ...
              tmp.push(...tail);
              tmp.push(...value);
              value = new Uint8Array(tmp);
            }
            let n = -1;
            for (let i = value.length - 1; i > 0; i -= 2) {
              if (value[i] == 10 && value[i - 1] == 13) {
                n = i + 1;
                break;
              }
            }
            tail = value.slice(n, value.length);
            term.write(decoder.decode(value.slice(0, n)));
          }
          if (done) {
            reader.releaseLock();
            break;
  ...
  document.addEventListener("DOMContentLoaded", initSerial);
})();
